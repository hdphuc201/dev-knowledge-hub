...
| P00-009 | DONE   | Add GitHub Actions quality workflow for install, format, lint, typecheck, test, and build.                                                         | Workflow file is syntactically valid and references existing scripts.          |
